...
export default function FeatureNavigationButton({
  ...
  return (
    <button
      role="button"
      onClick={onClick}
      className={`flex w-full min-w-[280px] flex-1 cursor-pointer items-center justify-center gap-x-4 border-r border-neutral-300 px-6 py-4 transition-colors last:border-r-0 xl:min-w-[270px] ${isActive ? 'animate-feature-svg bg-action/5' : 'bg-white'}`}
    >
